const { Farm, Crop, Wheat, Sugarcane } = require('./crops')

test('The Wheat class can calculate yields', () => {
...
test('The Sugarcane class can calculate yields', () => {
...
test('A crop can store its area size', () => {
    const crop = new Crop(1234);
    expect(crop.acres).toBe(1234);
})
